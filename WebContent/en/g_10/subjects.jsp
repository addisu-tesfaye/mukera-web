	...
	<div class="collapse navbar-toggleable-xs" id="collapseEx2">
            ...
            <ul class="nav navbar-nav">
                ...
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle" type="button" id="dropdownMenu1" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"id = "grade_10">Grade 10</a>
		...
		<div class="card-block">
			...
			<div class="btn-group dropup">
				...
				<div class="dropdown-menu">
					<a class="dropdown-item" href="cookie.jsp" onclick="findYear(this.innerHTML)">2001</a>
					<a class="dropdown-item" href="#" onclick="findYear(this.innerHTML)">2002</a>
					<a class="dropdown-item" href="#" onclick="findYear(this.innerHTML)">2003</a>
					<a class="dropdown-item" href="#" onclick="findYear(this.innerHTML)">2004</a>
					<a class="dropdown-item" href="#" onclick="findYear(this.innerHTML)">2005</a>
					<a class="dropdown-item" href="#" onclick="findYear(this.innerHTML)">2006</a>
					<a class="dropdown-item" href="#" onclick="findYear(this.innerHTML)">2007</a>
					<a class="dropdown-item" href="#"onclick="findYear(this.innerHTML)">2008</a>
				</div>
			</div>
			</form>
